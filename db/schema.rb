...
ActiveRecord::Schema.define(version: 2019_07_30_121303) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "cart_proucts", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "cart_id"
    ...
    t.integer "quantity"
    t.decimal "cost"
    t.index ["cart_id"], name: "index_cart_proucts_on_cart_id"
    t.index ["product_id"], name: "index_cart_proucts_on_product_id"
  end
  ...
  add_foreign_key "cart_proucts", "carts"
  add_foreign_key "cart_proucts", "products"
